...
namespace HEM02
{
    ...
    public class M3Car
    {
        public string Brand { get; set; } //  get == read set == write
        ...
        public M3Car(string _Brand, string _Model) // 2 different constructors loul when object is created you can choose wich one to use
        {
            Model = _Model;
            Brand = _Brand;
        }
